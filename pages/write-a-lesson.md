...
Pleas note that it is preferable to use resources with persistent identifiers (such as DOI and permalinks) in order to provide a lesson that will remain sustainable and accessible. 
